...
var TABS = [{ title: "racecars", content: "racecars are fast" }, { title: "racecars2", content: "racecars are slow" }, { title: "racecars3", content: "racecars are kinda of fast" }];
...
var Clock = function (_React$Component) {
  ...
  function Clock(props) {
    ...
    setInterval(_this.tick.bind(_this), 1000);
    return _this;
  }
...
var Tabs = function (_React$Component) {
  ...
  _createClass(Tabs, [{
    ...
    value: function render() {
      ...
      var results = this.tabs.map(function (object, idx) {
        var active = "";
        var onClickHandler = function onClickHandler() {
          return _this2.handleClick(idx);
        };
        if (idx === _this2.state.activeIndex) {
          active = "active";
        } else {
          active = "inactive";
        }
